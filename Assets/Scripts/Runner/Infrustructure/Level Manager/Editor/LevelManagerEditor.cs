...
namespace Runner.Infrustructure.Editor
{
    ...
    public class LevelManagerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            _editorMode.boolValue = GUILayout.Toggle(_editorMode.boolValue, new GUIContent("Editor Mode"),
            ...
            if (GUILayout.Button("Delete Saves", GUILayout.Width(200), GUILayout.Height(20)))
            {
                ...
                if (File.Exists(Path.Combine(Application.dataPath,
                        @"YandexGame\WorkingData\Editor\SavesEditorYG.json")))
        ...
        private void DrawSelectedLevel()
        {
            ...
            var index = EditorGUILayout.IntField("Current Level", _levelManager.CurrentLevelIndex + 1);
            ...
            if (GUILayout.Button("<<", GUILayout.Width(30), GUILayout.Height(20))) _levelManager.PrevLevel();
            if (GUILayout.Button(">>", GUILayout.Width(30), GUILayout.Height(20))) _levelManager.NextLevel();
